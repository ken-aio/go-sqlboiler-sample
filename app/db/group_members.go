...
var (
	groupMemberColumns               = []string{"id", "user_id", "group_id", "role", "created_at", "updated_at"}
...
// OneG returns a single groupMember record from the query using the global executor.
func (q groupMemberQuery) OneG(ctx context.Context) (*GroupMember, error) {
	return q.One(ctx, boil.GetContextDB())
}

// OneGP returns a single groupMember record from the query using the global executor, and panics on error.
func (q groupMemberQuery) OneGP(ctx context.Context) *GroupMember {
...
func (q groupMemberQuery) OneP(ctx context.Context, exec boil.ContextExecutor) *GroupMember {
...
// AllG returns all GroupMember records from the query using the global executor.
func (q groupMemberQuery) AllG(ctx context.Context) (GroupMemberSlice, error) {
	return q.All(ctx, boil.GetContextDB())
}

// AllGP returns all GroupMember records from the query using the global executor, and panics on error.
func (q groupMemberQuery) AllGP(ctx context.Context) GroupMemberSlice {
...
func (q groupMemberQuery) AllP(ctx context.Context, exec boil.ContextExecutor) GroupMemberSlice {
...
// CountG returns the count of all GroupMember records in the query, and panics on error.
func (q groupMemberQuery) CountG(ctx context.Context) (int64, error) {
	return q.Count(ctx, boil.GetContextDB())
}

// CountGP returns the count of all GroupMember records in the query using the global executor, and panics on error.
func (q groupMemberQuery) CountGP(ctx context.Context) int64 {
...
func (q groupMemberQuery) CountP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (q groupMemberQuery) ExistsG(ctx context.Context) (bool, error) {
	return q.Exists(ctx, boil.GetContextDB())
}

// ExistsGP checks if the row exists in the table using the global executor, and panics on error.
func (q groupMemberQuery) ExistsGP(ctx context.Context) bool {
...
func (q groupMemberQuery) ExistsP(ctx context.Context, exec boil.ContextExecutor) bool {
...
// SetGroupG of the groupMember to the related item.
// Sets o.R.Group to related.
// Adds o to related.R.GroupMembers.
// Uses the global database handle.
func (o *GroupMember) SetGroupG(ctx context.Context, insert bool, related *Group) error {
	return o.SetGroup(ctx, boil.GetContextDB(), insert, related)
}

// SetGroupP of the groupMember to the related item.
// Sets o.R.Group to related.
// Adds o to related.R.GroupMembers.
// Panics on error.
func (o *GroupMember) SetGroupP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Group) {
	if err := o.SetGroup(ctx, exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetGroupGP of the groupMember to the related item.
// Sets o.R.Group to related.
// Adds o to related.R.GroupMembers.
// Uses the global database handle and panics on error.
func (o *GroupMember) SetGroupGP(ctx context.Context, insert bool, related *Group) {
...
// SetUserG of the groupMember to the related item.
// Sets o.R.User to related.
// Adds o to related.R.GroupMembers.
// Uses the global database handle.
func (o *GroupMember) SetUserG(ctx context.Context, insert bool, related *User) error {
	return o.SetUser(ctx, boil.GetContextDB(), insert, related)
}

// SetUserP of the groupMember to the related item.
// Sets o.R.User to related.
// Adds o to related.R.GroupMembers.
// Panics on error.
func (o *GroupMember) SetUserP(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) {
	if err := o.SetUser(ctx, exec, insert, related); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetUserGP of the groupMember to the related item.
// Sets o.R.User to related.
// Adds o to related.R.GroupMembers.
// Uses the global database handle and panics on error.
func (o *GroupMember) SetUserGP(ctx context.Context, insert bool, related *User) {
...
func FindGroupMemberG(ctx context.Context, iD int64, selectCols ...string) (*GroupMember, error) {
	return FindGroupMember(ctx, boil.GetContextDB(), iD, selectCols...)
}

// FindGroupMemberP retrieves a single record by ID with an executor, and panics on error.
func FindGroupMemberP(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) *GroupMember {
	retobj, err := FindGroupMember(ctx, exec, iD, selectCols...)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func FindGroupMemberGP(ctx context.Context, iD int64, selectCols ...string) *GroupMember {
	retobj, err := FindGroupMember(ctx, boil.GetContextDB(), iD, selectCols...)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func (o *GroupMember) InsertG(ctx context.Context, columns boil.Columns) error {
	return o.Insert(ctx, boil.GetContextDB(), columns)
}

// InsertP a single record using an executor, and panics on error. See Insert
// for whitelist behavior description.
func (o *GroupMember) InsertP(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) {
...
func (o *GroupMember) InsertGP(ctx context.Context, columns boil.Columns) {
...
// UpdateG a single GroupMember record using the global executor.
// See Update for more documentation.
func (o *GroupMember) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
	return o.Update(ctx, boil.GetContextDB(), columns)
}

// UpdateP uses an executor to update the GroupMember, and panics on error.
// See Update for more documentation.
func (o *GroupMember) UpdateP(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) int64 {
...
// UpdateGP a single GroupMember record using the global executor. Panics on error.
// See Update for more documentation.
func (o *GroupMember) UpdateGP(ctx context.Context, columns boil.Columns) int64 {
...
func (o *GroupMember) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("db: unable to update group_members, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update group_members row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by update for group_members")
	}
...
func (q groupMemberQuery) UpdateAllP(ctx context.Context, exec boil.ContextExecutor, cols M) int64 {
...
func (q groupMemberQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (q groupMemberQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update all for group_members")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to retrieve rows affected for group_members")
	}
...
// UpdateAllG updates all rows with the specified column values.
func (o GroupMemberSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
	return o.UpdateAll(ctx, boil.GetContextDB(), cols)
}

// UpdateAllGP updates all rows with the specified column values, and panics on error.
func (o GroupMemberSlice) UpdateAllGP(ctx context.Context, cols M) int64 {
...
func (o GroupMemberSlice) UpdateAllP(ctx context.Context, exec boil.ContextExecutor, cols M) int64 {
...
func (o GroupMemberSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to update all in groupMember slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to retrieve rows affected all in update all groupMember")
	}
	return rowsAff, nil
}

// UpsertG attempts an insert, and does an update or ignore on conflict.
func (o *GroupMember) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// UpsertGP attempts an insert, and does an update or ignore on conflict. Panics on error.
func (o *GroupMember) UpsertGP(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) {
...
func (o *GroupMember) UpsertP(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) {
...
func (o *GroupMember) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to upsert group_members")
	}
...
func (o *GroupMember) DeleteG(ctx context.Context) (int64, error) {
...
// Panics on error.
func (o *GroupMember) DeleteP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
// Panics on error.
func (o *GroupMember) DeleteGP(ctx context.Context) int64 {
...
func (o *GroupMember) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("db: no GroupMember provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete from group_members")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by delete for group_members")
	}
...
func (q groupMemberQuery) DeleteAllP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (q groupMemberQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("db: no groupMemberQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete all from group_members")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "db: failed to get rows affected by deleteall for group_members")
	}
...
func (o GroupMemberSlice) DeleteAllG(ctx context.Context) (int64, error) {
	return o.DeleteAll(ctx, boil.GetContextDB())
}

// DeleteAllP deletes all rows in the slice, using an executor, and panics on error.
func (o GroupMemberSlice) DeleteAllP(ctx context.Context, exec boil.ContextExecutor) int64 {
...
func (o GroupMemberSlice) DeleteAllGP(ctx context.Context) int64 {
...
func (o GroupMemberSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("db: no GroupMember slice provided for delete all")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "db: unable to delete all from groupMember slice")
	}
...
func (o *GroupMember) ReloadG(ctx context.Context) error {
	if o == nil {
...
func (o *GroupMember) ReloadP(ctx context.Context, exec boil.ContextExecutor) {
...
func (o *GroupMember) ReloadGP(ctx context.Context) {
...
func (o *GroupMemberSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
...
// and overwrites the original object slice with the newly updated slice.
// Panics on error.
func (o *GroupMemberSlice) ReloadAllP(ctx context.Context, exec boil.ContextExecutor) {
...
// and overwrites the original object slice with the newly updated slice.
// Panics on error.
func (o *GroupMemberSlice) ReloadAllGP(ctx context.Context) {
...
func GroupMemberExistsG(ctx context.Context, iD int64) (bool, error) {
	return GroupMemberExists(ctx, boil.GetContextDB(), iD)
}

// GroupMemberExistsP checks if the GroupMember row exists. Panics on error.
func GroupMemberExistsP(ctx context.Context, exec boil.ContextExecutor, iD int64) bool {
	e, err := GroupMemberExists(ctx, exec, iD)
	if err != nil {
		panic(boil.WrapErr(err))
	}
...
func GroupMemberExistsGP(ctx context.Context, iD int64) bool {
	e, err := GroupMemberExists(ctx, boil.GetContextDB(), iD)
	if err != nil {
		panic(boil.WrapErr(err))
	}
